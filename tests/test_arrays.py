...
class TestArrays(unittest.TestCase):
    ...
    def test_uniq(self):
        ...
        self.assertEqual(
            [{'name': 'moe'}, {'name': 'curly'}, {'name': 'larry'}], _.uniq(tlist, iterator),
            'can find the unique values of an array using a custom iterator')

        tlist = [1, 2, 2, 3, 4, 4]
        iterator = lambda value, *args: value + 1
        self.assertEqual([1, 2, 3, 4], _.uniq(tlist, iterator),
    ...
    def test_intersection(self):
        stooges = ['moe', 'curly', 'john', 'larry']
        leaders = ['moe', 'groucho', 'john']
        self.assertEqual(['moe', 'john'], _.intersection(stooges, leaders),
    ...
    def test_zip(self):
        ...
        ages = [30, 40, 50]
        leaders = [True]
        stooges = list(_.zip(names, ages, leaders))
